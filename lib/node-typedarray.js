...
if (_ArrayBuffer_) {
	...
	/* 
	previous V8 versions do not implement slice for ArrayBuffers but for Typed Arrays
	replace below this.byteOffset+o by o
	and change above in the slice method : return this.buffer.slice(start,end);
	*/
...
As long as node.js's Buffers have the same properties as ArrayBuffers and Typed Arrays, you can use both without converting them explicitely 
...
/* Examples - note that 'new' is not required for ArrayBuffer/Typed Array but used for compatibility reasons with Buffers
